...
Schema.createSchema = function(mongoose) {
	...
	var UserSchema = mongoose.Schema({
      nickName: {type: String, required: true, unique: false, 'default':''}, // google user로 받음
	    email: {type: String, required: true, unique: true, 'default':''}, // google user로 받음
	    hashed_password: {type: String,'default':''}, // 사용x
	    salt: {type: String, required:true}, // 사용x(인증용)
	    club_name: {type: String, 'default':'none'}, // 필수는 아님
